...
use MspPack\DDSAdmin\Repositories\RoleRepo;
...
class UserController extends Controller
{
    ...
    public function __construct(Request $request,UserRepo $UserRepo,RoleRepo $RoleRepo,SettingRepo $SettingRepo)
    {
        ...
        $this->view_path = 'admin.users.user';
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/user/')->with('error', 'Can not be created');
    }
    ...
    {
    	return redirect('admin/user')->with('error', 'You can not delete any user');
    }
    ...
    public function postProfile(Request $request)
    {
        ...
        return redirect('admin/user/profile')->with('error', 'Can not be updated');
    }
}
