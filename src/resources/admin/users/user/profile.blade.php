...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                {!! Form::model($item, array('method' => 'POST', 'url' => '/admin/user/profile','class'=>'form-horizontal')) !!}
                ...
                <div class="form-group m-b-0">
                    <div class="col-sm-offset-3 col-sm-9">
                        ...
                        <a class="btn btn-danger waves-effect waves-light m-t-10" href="{{ url('/admin/home') }}">Cancel</a>
                    </div>
                </div>
                {!! Form::close() !!}
            </div>
