...
<section id="wrapper" class="new-login-register">
    <div class="new-login-box">
        <div class="white-box">
            ...
            <form class="form-horizontal new-lg-form" role="form" method="POST" action="/admin/register">
                {{ csrf_field() }}
                ...
                <div class="form-group m-b-0">
                    <div class="col-sm-12 text-center">
                        <p>Already have an account? <a href="/admin/login" class="text-danger m-l-5"><b>Sign In</b></a></p>
                    </div>
                </div>
            </form>
            {!! Captcha::script() !!}
