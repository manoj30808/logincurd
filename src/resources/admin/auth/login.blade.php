...
<section id="wrapper" class="new-login-register">
    <div class="new-login-box">
        <div class="white-box">
            ...
            <form class="form-horizontal new-lg-form" role="form" id="loginform" method="POST" action="/admin/login">
                {{ csrf_field() }}
                <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }} m-t-20">
                    <div class="col-xs-12">
                        <input placeholder="Email/Username" id="email" type="text" class="form-control" name="email" value="{{ old('email') }}" required autofocus>
                        @if ($errors->has('email'))
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <a href="/admin/password/reset" class="text-dark pull-right"><i class="fa fa-lock m-r-5"></i> Forgot pwd?</a> </div>
                    </div>
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            <p>Don't have an account? <a href="/admin/register" class="text-primary m-l-5"><b>Sign Up</b></a></p>
                        </div>
                    </div>
                </form>
                {!! Captcha::script() !!}
